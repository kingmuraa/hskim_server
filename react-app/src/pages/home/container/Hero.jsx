...
const Hero = () => {
    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
        <div className="mt-10 lg:w-1/2">
            <h1 className="font-roboto text-3xl text-center font-bold text-dark-hard lg:text-4xl xl:text-5xl md:text-5l lg:text-left lg:max-w-[540px]">Articles</h1>
            ...
            <div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
                ...
                <button className="w-full bg-primary text-white font-semibold rounded-lg px-5 py-3 md:absolute md:right-2  md:translate-y-1/4 md:w-fit md:py-2">Search</button>
            </div>
        ...
        <div className="hidden lg:block lg:1/2">
            <img className="ml-2 w-full" src={images.HeroImage} alt="users are reading articles" width={"20px"} height={"20px"}/>
        </div>
    </section>
    )
};
