...
const Hero = () => {
    ...
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
        <div className="mt-10 lg:w-1/2">
            <h1 className="font-roboto text-3xl text-center font-bold text-dark-hard md:text-5l lg:text-left lg:max-w-[540px]">Articles</h1>
        ...
        <div className="hidden lg:block lg:1/2">
            <img className="ml-2 w-full" src={images.HeroImage} alt="users are reading articles" />
        </div>
    </section>
    )
};
